...
class NAFBlock(nn.Module):
    def __init__(self, c, DW_Expand=2, FFN_Expand=2, drop_out_rate=0.):
        ...
        self.conv1 = nn.Conv2d(in_channels=c, out_channels=c // 2, kernel_size=1, padding=0, stride=1, groups=1, bias=True)
        ...
        self.conv5 = nn.Conv2d(in_channels=2*c, out_channels=c, kernel_size=3, padding=1, stride=1, groups=1, bias=True) #3x3

        self.conv6 = nn.Conv2d(in_channels=2*c, out_channels=c // 4, kernel_size=5, padding=2, stride=1, groups=1, bias=True) #5x5 size of output volume = (W-F+2P)/S+1

        self.conv7 = nn.Conv2d(in_channels=c, out_channels=c//4, kernel_size=1, padding=0, stride=1, groups=1, bias=True)#1x1
